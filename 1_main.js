...
let exepensesValue = document.getElementsByClassName("expenses-value")[0];
let optionalExpensesValue = document.getElementsByClassName(
  "optionalexpenses-value"
)[0];
let incomeValue = document.getElementsByClassName("income-value")[0];
let montgSavingsValue = document.getElementsByClassName(
  "monthsavings-value"
)[0];
...
expensesBtn.addEventListener("click", function() {
  ...
  exepensesValue.textContent = sum;
});
...
countBtn.addEventListener("click", function() {
  if (appData.budget != undefined) {
    appData.moneyPerDay = ((appData.budget - +gidexepensesValue.textContent) / 30).toFixed();
...
sumValue.addEventListener("input", function() {
  if (appData.savings == true) {
    ...
    montgSavingsValue.textContent = appData.monthIncome.toFixed(1);
